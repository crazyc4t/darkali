...
sleep 2
apt install kali-desktop-core git neovim python3 python3-pip libpangocairo-1.0-0 alsa-utils pavucontrol thunar suckless-tools lightdm kitty nitrogen picom golang-go neofetch rofi xorg xserver-xorg xinit python3-pip python3-xcffib python3-cairocffi keepassxc -yy
sleep 2
...
sleep 2
rm /usr/share/xsessions/lightdm-xsessions.desktop
sleep 2
